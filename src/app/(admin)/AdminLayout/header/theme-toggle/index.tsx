...
export function ThemeToggleSwitch() {
  ...
  return (
    <button
      ...
      className="group rounded-full bg-gray-3 p-[5px] text-[#111928] outline-1 outline-primary focus-visible:outline dark:bg-[#020D1A] dark:text-current hover:ring-2 hover:ring-gray-200 dark:hover:ring-gray-700 transition-all duration-200 hover:scale-105"
    >
